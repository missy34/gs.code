//section 1
//APIを利用する際のURLになります
var KEY = 'AIzaSyB3kx-qpNmBNAgwpNDWE8YwiUJXfhcUZ7Y'
...
function showResult(result){
    ...
    if(result.responses[0].faceAnnotations){
        ...
        $("#chartArea").append("<div><b>写真に写っている人はいません</b></div>");
    }
    //テキスト解読の結果を表示
    if(result.responses[0].textAnnotations){
        ...
        $("#textBox").append("<tr><td class='resultTableContent'><b>画像にテキストが見つかりません</b></td></tr>")
    }
}